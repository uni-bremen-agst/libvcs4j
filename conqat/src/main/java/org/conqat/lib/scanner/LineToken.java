...
/**
 * Class for LINE tokens generated by the LINE scanner. This does only add the
 ...
 * @see org.conqat.lib.scanner.LineScanner
 */
public class LineToken extends Token {
	 ...
	 *            origin id
	 */
	/* package */LineToken(ETokenType type, int offset, int lineNumber,
	...
	/** {@inheritDoc} */
	@Override
	public LineToken newToken(ETokenType type, int offset, int lineNumber,
			String text, String originId) {
		return new LineToken(type, offset, lineNumber, text, originId);
	}
}
