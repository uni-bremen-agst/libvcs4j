 ...
 * @version $Rev: 48750 $
 * @ConQAT.Rating GREEN Hash: B4C0763A026675DC0EA07347D1547A92
 */
public class SerializedIntField extends SerializedPrimitiveFieldBase {

	/** The type code. */
	public static final char TYPE_CODE = 'I';

	/** Constructor. */
	public SerializedIntField(String name) {
		super(name);
	}
	...
	public void writeValue(Object value, SerializedEntityPool pool,
			...
			throws IOException {
		dos.writeInt(ensureType(value, Integer.class));
	}
