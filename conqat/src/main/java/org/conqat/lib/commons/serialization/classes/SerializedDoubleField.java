 ...
 * @version $Rev: 48750 $
 * @ConQAT.Rating GREEN Hash: 322AE3D226B99EE0232296F6E2CC2EDE
 */
public class SerializedDoubleField extends SerializedPrimitiveFieldBase {

	/** The type code. */
	public static final char TYPE_CODE = 'D';

	/** Constructor. */
	public SerializedDoubleField(String name) {
		super(name);
	}
	...
	public void writeValue(Object value, SerializedEntityPool pool,
			...
			throws IOException {
		dos.writeDouble(ensureType(value, Double.class));
	}
