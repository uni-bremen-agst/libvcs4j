...
public class SpoonModelBuilder {
	 ...
	 *
	 * @return The last built {@link SpoonModel}.
	 */
	 ...
	 *
	 * @param range The currently checked out range.
	 * @return The result class that contains {@link #model} and {@code range}.
	 * @throws NullPointerException If {@code range} is {@code null}.
	 * @throws BuildException       If an error occurred while building the model.
	 */
	 ...
	 *
	 * @param input The input source files.
	 * @return A {@link FilteringFolder} containing all files from the given
	 * input.
	 */
	 ...
	 * @return The canonicalized version of {@code path}.
	 */
	 ...
	 *
	 * @param path The string path to canonicalize.
	 * @return The canonicalized version of {@code path} as {@link Path}.
	 */
	 ...
	 * @return The canonicalized version of {@code file} as {@link Path}.
	 */
	 ...
	 * as well.
	 *
	 * @param paths The changed source files.
	 */
	 ...
	 *
	 * @param pkg The root package of the package tree to process.
	 */
	 ...
	 *
	 * @return All sources files which were not compiled by the last call of
	 * {@link #update(RevisionRange)}.
	 */
	 ...
	 *
	 * @param changes The list of {@link FileChange} objects to process.
	 * @return The List of old file paths.
	 */
	 ...
	 * itself.
	 *
	 * @param pFiles The list of files (denoted as paths) to process.
