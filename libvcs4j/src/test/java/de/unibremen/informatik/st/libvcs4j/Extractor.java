...
public class Extractor {
     ...
     * created directory has permissions 700.
     *
     * The created directory will be removed automatically using a shutdown
     * hook (see {@link DeleteTask}).
     *
     * @param pTarGZ
     ...
     */
    public Path extractTarGZResource(final String pTarGZ) throws IOException {
        ...
        Runtime.getRuntime().addShutdownHook(new DeleteTask(tmpDir));
