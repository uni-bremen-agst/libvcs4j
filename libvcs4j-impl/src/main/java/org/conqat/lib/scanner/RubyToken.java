...
/**
 * Class for RUBY tokens generated by the RUBY scanner. This does only add the
 ...
 * @see org.conqat.lib.scanner.RubyScanner
 */
public class RubyToken extends Token {

	/**
	 * Create new Ruby token.
	 * 
	 * @param type
	 *            token type
	 * @param offset
	 ...
	 *            origin id
	 */
	/* package */RubyToken(ETokenType type, int offset, int lineNumber,
	...
	/** {@inheritDoc} */
	@Override
	public RubyToken newToken(ETokenType type, int offset, int lineNumber,
			String text, String originId) {
