 ...
 * @version $Rev: 48750 $
 * @ConQAT.Rating GREEN Hash: 3775EDD819BDFD616B0BAB28A9CB7C27
 */
public class SerializedCharField extends SerializedPrimitiveFieldBase {

	/** The type code. */
	public static final char TYPE_CODE = 'C';

	/** Constructor. */
	public SerializedCharField(String name) {
		super(name);
	}
	...
	public void writeValue(Object value, SerializedEntityPool pool,
			...
			throws IOException {
		dos.writeChar(ensureType(value, Character.class));
	}
